...
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { buttons_tri_i[4] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=JA1_R_N
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { buttons_tri_i[5] }]; #IO_L22N_T3_AD7N_35 Sch=JA2_R_N
set_property -dict { PACKAGE_PIN J16   IOSTANDARD LVCMOS33 } [get_ports { buttons_tri_i[6] }]; #IO_L24N_T3_AD15N_35 Sch=JA3_R_N
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { buttons_tri_i[7] }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N
