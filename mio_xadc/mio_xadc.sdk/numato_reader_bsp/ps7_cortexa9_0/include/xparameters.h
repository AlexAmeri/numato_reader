...
/* Definitions for peripheral BUTTON_DRIVER */
#define XPAR_BUTTON_DRIVER_BASEADDR 0x41210000
#define XPAR_BUTTON_DRIVER_HIGHADDR 0x4121FFFF
#define XPAR_BUTTON_DRIVER_DEVICE_ID 0
#define XPAR_BUTTON_DRIVER_INTERRUPT_PRESENT 0
#define XPAR_BUTTON_DRIVER_IS_DUAL 0


/* Definitions for peripheral LED_DRIVER */
#define XPAR_LED_DRIVER_BASEADDR 0x41200000
#define XPAR_LED_DRIVER_HIGHADDR 0x4120FFFF
#define XPAR_LED_DRIVER_DEVICE_ID 1
#define XPAR_LED_DRIVER_INTERRUPT_PRESENT 0
#define XPAR_LED_DRIVER_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral BUTTON_DRIVER */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_BUTTON_DRIVER_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral LED_DRIVER */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_LED_DRIVER_DEVICE_ID
